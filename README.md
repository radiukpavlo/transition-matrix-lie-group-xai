...
**Матриця B (MM) — Інтерпретовані Параметри:**
$$
\begin{pmatrix}
-1.9794 & 1.9593 & -1.3811 & -1.7296 \\
-1.9749 & 1.9485 & -1.7266 & -1.7612 \\
-1.8439 & 1.9982 & -1.9129 & -1.9751 \\
-1.9986 & 1.9997 & -1.9984 & -1.9998 \\
-1.9994 & 1.9989 & -1.9996 & -1.9989 \\
1.9978 & -1.8440 & 1.6601 & -1.3735 \\
1.8188 & -1.9097 & 1.2066 & -1.4080 \\
1.9920 & -1.9238 & 0.7066 & -1.5438 \\
1.9992 & -1.9976 & 0.2122 & -1.5870 \\
1.9979 & -1.9994 & -0.2434 & -1.8276 \\
0.8516 & 1.5742 & 1.5810 & 1.5739 \\
1.0085 & 1.5708 & 1.5957 & 1.7418 \\
1.1077 & 1.6155 & 1.7236 & 1.8076 \\
1.0899 & 1.6114 & 1.8825 & 1.8735 \\
1.2904 & 1.6953 & 1.9535 & 1.9463 \\
\end{pmatrix}
$$

**Базова Матриця Переходу $T_{old}$ (Fidelity-only):**
$$
\begin{pmatrix}
-0.2781 & 0.5206 & -0.1404 & 0.0244 \\
-0.3822 & 0.1260 & -0.1450 & 0.3490 \\
0.5229 & -0.3411 & 0.4333 & 0.1988 \\
-0.0659 & -0.0233 & -0.1498 & -0.2559 \\
-0.1776 & -0.4995 & -0.4288 & -0.6169 \\
\end{pmatrix}
$$

**Розрахована Матриця Переходу $T_{old\_calc}$ (SVD, $\lambda=0$):**

Ця матриця обчислена за допомогою SVD-підходу з рукопису (Алгоритм 1 при $\lambda=0$), без використання методу найменших квадратів:
$$
\begin{pmatrix}
...
> **Примітка:** $T_{old\_calc}$ має розмірність $(l \times k) = (4 \times 5)$, на відміну від $T_{old}$ з Додатку 1.1, який має розмірність $(k \times l) = (5 \times 4)$. Це пов'язано з тим, що SVD-рішення природно дає $T \in \mathbb{R}^{l \times k}$ для рівняння $B \approx A T^\top$.
